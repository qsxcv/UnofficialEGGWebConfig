...
[`../Endgame_8k_Mice_MultiDevice_Protocol.md`](../Endgame_8k_Mice_MultiDevice_Protocol.md)
and [`../OP1_8k_v2_USB_Protocol.md`](../OP1_8k_v2_USB_Protocol.md).
...
- **Live events:** the app listens to input report `0x03` - pressing the physical
  ...
  the UI in real time.
- **Sensor / performance:** polling rate (1000/2000/4000/8000 Hz as divider byte),
...
- **Custom polling dividers** beyond the four stock rates, and writing a divider
  while Glass Mode is active (the control locks; the byte is left as-is because
  the divider the official tool forces there is not pinned down in the docs).
